...
But it is complete in sense of datamapper.

With DM-2 around the corner (https://github.com/datamapper/dm-core/wiki/roadmap)
we'll spend our development effort to implement the following mongo specific 
features in a dm-2 version of this adapter:
